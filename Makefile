...
HOSTCC       = ccache gcc
HOSTCXX      = ccache g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -Ofast -ftree-vectorize -fomit-frame-pointer -DNDEBUG
HOSTCXXFLAGS = -Ofast -ftree-vectorize -DNDEBUG
...
OPTIMIZATION_FLAGS = -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4 \
                     ...
                     -mvectorize-with-neon-quad -DNDEBUG -marm
